...
output_json_path = os.path.join(main_script_dir, "grayscale_params.json")
...
target_matrix[1] = grayscale_kernel
target_matrix[2:, :] = (1-grayscale_kernel)/3  # Fill the rest with average value
